...
CREATE TABLE `orders` (
    ...
    `status` ENUM('PROCESSED', 'SHIPPED', 'COMPLETED', 'CANCELED') NOT NULL DEFAULT 'PROCESSED',
    `address_text` VARCHAR(191) NOT NULL,
    `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updated_at` DATETIME(3) NOT NULL,
...
CREATE TABLE `payments` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `order_id` INTEGER NOT NULL,
    `method` ENUM('CASH', 'BANK_TRANSFER', 'EWALLET') NOT NULL,
